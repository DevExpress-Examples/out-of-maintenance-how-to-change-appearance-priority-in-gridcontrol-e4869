...
Namespace GridControlDescendant
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			Me.myGridControl1 = New GridControlDescendant.MyGridControl()
			Me.myGridView1 = New GridControlDescendant.MyGridView()
			...
			Me.myGridControl1.Size = New System.Drawing.Size(760, 649)
			...
			Me.myGridView1.OptionsSelection.MultiSelectMode = DevExpress.XtraGrid.Views.Grid.GridMultiSelectMode.CellSelect
			' 
			' gridColumn1
			' 
			Me.gridColumn1.AppearanceCell.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(128))))), (CInt(Fix((CByte(128))))))
			...
			' gridColumn2
			' 
			Me.gridColumn2.Caption = "value1"
			Me.gridColumn2.FieldName = "Value1"
			...
			' gridColumn3
			' 
			Me.gridColumn3.Caption = "value2"
			Me.gridColumn3.FieldName = "Value2"
